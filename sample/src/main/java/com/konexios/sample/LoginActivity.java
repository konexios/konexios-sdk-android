...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApiService = App.getAcnApiService();
        initViews();
    }
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            mApiService.registerAccount(model, new RegisterAccountListener() {
                @Override
            ...
            model.setUsername(email.trim());
            model.setPassword(password.trim());
            model.setApplicationCode(code.trim());

            Api.Builder.resetDefaultAdminEndpoint();
            mApiService.registerAccount2(model, new RegisterAccount2Listener() {
                @Override
                public void onAccountRegistered(AccountResponse2 response) {
                    ...
                    Api.Builder.resetDefaultGatewayEndpoint();
                    startActivity(intent);
                    finish();
                    showProgress(false);
                }
