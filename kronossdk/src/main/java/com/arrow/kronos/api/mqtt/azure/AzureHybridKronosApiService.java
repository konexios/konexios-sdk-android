...
public final class AzureHybridKronosApiService extends AbstractMqttKronosApiService {
    private static final String TAG = AzureHybridKronosApiService.class.getName();
    ...
    public AzureHybridKronosApiService(String gatewayUid, String accessKey, String host) {
        super(gatewayUid);
