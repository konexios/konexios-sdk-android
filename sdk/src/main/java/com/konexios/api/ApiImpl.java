...
/**
 * Implementation of public com.konexios.com.konexios.api methods
 */

@Keep
final class ApiImpl implements ApiService, SenderServiceArgsProvider {
    ...
    private RestApiService mRestService;
    ...
    ApiImpl(RetrofitHolder retrofitHolder,
    ...
    void setRestEndpoint(@NonNull String endpoint, @NonNull String apiKey, @NonNull String apiSecret) {
        ...
        mRestService = mRetrofitHolder.getRestApiService(endpoint);
    }
